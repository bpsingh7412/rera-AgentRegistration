...
@Entity(name = "AgentPaymentDetailModel")
@Table(name = "TL_AGENT_PAYMENT_DETAILS")
public class AgentPaymentDetailModel implements Serializable {
	...
	@Column(name = "AGENT_ID_PAYMENT_FK")
